...
function updateSpots2(state, appointments) {
 ...
 //spots
  const appoints = filterDay[0].appointments.map(info => console.log(appointments[info]))

  // const appoint = filterDay[0].appointments.map((appointmentID) => state.appointments[appointmentID])
  return filterDay
}
