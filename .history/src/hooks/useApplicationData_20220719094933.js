...
function updateSpots2(state, appointments) {
 ...
 //Find Spot count
  ...
  const newfilter = filterDay.flat()
  console.log(newfilter, filterDay[0])
  // newfilter.spots = spots
  const newDay = [...newfilter]
  console.log(newDay, "newday")
  //Make updated mock-state
  const daysCopy = [...state.days]
  daysCopy[dayIndex] = filterDay[0]
  // const returnAll = {...state, days}
